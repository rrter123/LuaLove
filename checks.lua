...
function checks.around(posx, posy, currentmap)
  if currentmap[posy+1][posx]%10>1 then return currentmap[posy+1][posx], posy+1, posx end
  if currentmap[posy-1][posx]%10>1 then return currentmap[posy-1][posx], posy-1, posx end
  if currentmap[posy][posx+1]%10>1 then return currentmap[posy][posx+1], posy, posx+1 end
  if currentmap[posy][posx-1]%10>1 then return currentmap[posy][posx-1], posy, posx-1 end
  return 0 
end
